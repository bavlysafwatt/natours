...
function normalizeValue(value) {
  ...
  return _utils.default.isArray(value) ? value.map(normalizeValue) : stripTrailingCRLF(String(value));
}
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          (0, _alert.showAlert)('success', 'Tour booked successfully!');
          location.assign('/');
          _context.n = 3;
          break;
        case 2:
...
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(passwordCurrent, password, passwordConfirm) {
    var res, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
        ...
        case 1:
          res = _context2.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Password updated successfully!');
            location.assign('/');
          }
          _context2.n = 3;
          break;
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alert.showAlert)('error', _t2.response.data.message);
        case 3:
          return _context2.a(2);
      }
    }, _callee2, null, [[0, 2]]);
...
if (mapBox) {
  ...
  if (locations) (0, _mapbox.displayMap)(locations);
}
if (loginForm) {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            ...
            _context2.n = 1;
            return (0, _updateUser.updateUser)(form);
          case 1:
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.n) {
          case 0:
            ...
            _context3.n = 1;
            return (0, _updateUser.updatePassword)(passwordCurrent, password, passwordConfirm);
          case 1:
      ...
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          case 0:
            ...
            _context4.n = 1;
            return (0, _checkout.bookTour)(tourId);
          case 1:
